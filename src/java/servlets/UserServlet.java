 ...
 * 6. Создать сервлет "UserServlet" в пакете servlets раздела Source Packages.
 ...
 *    ProcessRequest сервлета "UserServlet", который управляется веб контейнером
...
// // // //*    в поле класса "UserServlet"
 * 10. Чтобы получить объект класса -фасада, необходимо применять аннотацию @EJB 
 *    в поле класса "UserServlet"
 *    для полей класса "UserServlet". С помощью этой аннотации контейнер сервера приложений внедрит
