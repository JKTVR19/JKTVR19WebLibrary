    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            ...
            case "/login":
                ...
                if(user == null){
                    request.setAttribute("info", "Incorrect login or password");
                ...
                request.setAttribute("info", "You are logged in as " + user.getLogin());
...
//                    request.setAttribute("info", "You got out!");
//                }
//                request.getRequestDispatcher("/index.jsp").forward(request, response);
                break;
            ...
            case "/registration":
                ...
                request.setAttribute("info", "Reader \"" + reader.getFirstname() +" "+ reader.getLastname()+ "\" had added");
                request.getRequestDispatcher("/index.jsp").forward(request, response);
                break; 
                }
    }
